 ...
 *
 * @covers \PHPCompatibility\Sniffs\Lists\NewListInForeachSniff
 *
 * @uses    \PHPCompatibility\Tests\BaseSniffTest
 * @package PHPCompatibility
 * @author  Juliette Reinders Folmer <phpcompatibility_nospam@adviesenzo.nl>
 */
class NewListInForeachSniffTest extends BaseSniffTest
{
    const TEST_FILE = 'Sniffs/Lists/NewListInForeachTestCases.inc';
