...
class NewFunctionsSniffTest extends BaseSniffTest
{
    ...
    public function dataNewFunction()
    {
        return array(
            ...
            array('net_get_interfaces', '7.2', array(446), '7.3'),
            array('gmp_binomial', '7.2', array(447), '7.3'),
            array('gmp_lcm', '7.2', array(448), '7.3'),
            array('gmp_perfect_power', '7.2', array(449), '7.3'),
            array('gmp_kronecker', '7.2', array(450), '7.3'),
            array('ldap_exop_refresh', '7.2', array(451), '7.3'),
            array('openssl_pkey_derive', '7.2', array(452), '7.3'),
            array('socket_wsaprotocol_info_export', '7.2', array(453), '7.3'),
            array('socket_wsaprotocol_info_import', '7.2', array(454), '7.3'),
            array('socket_wsaprotocol_info_release', '7.2', array(455), '7.3'),
        );
    }
